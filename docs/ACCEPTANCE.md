...
- `npm run check`: **75 unit/backend tests passed**, with strict types, package boundaries, formatting, generated contracts and production build on Windows/Node 25.4.0.
