...
- A seed sender is an entry point, not the boundary of the work history. Where mail is in scope, inspect relevant sent messages, replies, receipts, enrollment notices, self-notes and earlier activity as well as the inbox. Choose date bounds from the work's timeline rather than only the current week. Distinguish an enquiry sent, a response received, an application accepted and a placement secured; one does not prove another. Reconcile user recollection against these records without discarding either observation. On a blind trial, discover this history from original systems rather than consulting the baseline.
